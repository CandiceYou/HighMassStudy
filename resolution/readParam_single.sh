...
for mass in {1000}
#for mass in {400,450,500,550,600,700,750,800,900,1000,1200,1400,1600,1800,2000}
do
MassStr+="$mass,"
((massIndex++))
done
...
for mass in {1000}
#or mass in {400,450,500,550,600,700,750,800,900,1000,1200,1400,1600,1800,2000}
do
